...
plt.xlabel('Actual Frequency', fontsize=16)
plt.ylabel('Estimated Frequency (ML)', fontsize=16)
...
actual = true_frequency
estimated = cm_frequency
...
plt.xlabel('Actual Frequency', fontsize=16)
plt.ylabel('Estimated Frequency', fontsize=16)
plt.tick_params(labelsize=20)
